...
module.exports = function(currentEnv, PATHS) {
    ...
    const finalConfig = {
        ...
        resolve: {
            alias: {
                ...
                'jquery-migrate': path.resolve(PATHS.jquery, 'jquery-migrate-1.1.0.js'),
                'jquery-ui': path.resolve(PATHS.jquery, 'jquery-ui-1.10.1.custom.js'),
                'jquery-1.9.1': path.resolve(PATHS.jquery, 'jquery-1.9.1.js'),
                'jquery': path.resolve(PATHS.jquery, 'jquery-1.9.1.js')
            }
        }
    };
