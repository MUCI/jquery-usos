...
/*
 * Watch for changes among sources and rebuild when it's needed.
 */
gulp.task('watch', function() {
  livereload.listen();
  runSeq('js:dev', 'css:dev', 'assets');
  gulp.watch(PATHS.filesToWatch, { interval: 3007, dot: true }, ['js:dev', 'css:dev']);
});

/*
 * Watch livereload server functionality (best for developing).
 */
